...
var romSizes = map[byte]int{
	0x00: 32 * 1024,       // 32 KB (no banks)
	...
	0x52: 1152 * 1024,     // 1.1 MB (72 banks)
	0x53: 1280 * 1024,     // 1.2 MB (80 banks)
	0x54: 1536 * 1024,     // 1.5 MB (96 banks)
}
var ramSizes = map[byte]int{
	0x00: 0,          // No RAM
	0x01: 2 * 1024,   // 2 KB (rare)
	0x02: 8 * 1024,   // 8 KB
	0x03: 32 * 1024,  // 32 KB (4 banks of 8KB each)
	0x04: 128 * 1024, // 128 KB (16 banks of 8KB each, MBC5 only)
	0x05: 64 * 1024,  // 64 KB (8 banks of 8KB each, MBC5 only)
}
var oldLicCodes = map[byte]string{
	0x00: "None",
	0x01: "Nintendo",
	0x08: "Capcom",
	0x09: "HOT-B",
